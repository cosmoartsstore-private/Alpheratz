...
internal static class IReadOnlyList_System_Collections_Generic_IReadOnlyList_string_
{
	...
	private unsafe static int Do_Abi_GetAt_0(nint thisPtr, uint index, nint* __return_value__)
	{
		...
		*__return_value__ = 0;
		try
		{
			readOnlyList = IReadOnlyListMethods<IReadOnlyList<string>>.Abi_GetAt_0(thisPtr, index);
	...
	private unsafe static int Do_Abi_IndexOf_2(nint thisPtr, nint value, uint* index, byte* __return_value__)
	{
		...
		*__return_value__ = 0;
		...
		try
		{
			flag = IReadOnlyListMethods<IReadOnlyList<string>>.Abi_IndexOf_2(thisPtr, MarshalInterface<IReadOnlyList<string>>.FromAbi(value), out index2);
			*index = index2;
	...
	private unsafe static int Do_Abi_GetMany_3(nint thisPtr, uint startIndex, int __itemsSize, nint items, uint* __return_value__)
	{
		...
		*__return_value__ = 0u;
		...
		try
		{
			num = IReadOnlyListMethods<IReadOnlyList<string>>.Abi_GetMany_3(thisPtr, startIndex, ref items2);
	...
	private unsafe static int Do_Abi_get_Size_1(nint thisPtr, uint* __return_value__)
	{
		...
		*__return_value__ = 0u;
		try
		{
			num = IReadOnlyListMethods<IReadOnlyList<string>>.Abi_get_Size_1(thisPtr);
			*__return_value__ = num;
		}
		catch (Exception ex)
		{
