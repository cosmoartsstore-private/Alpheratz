...
internal static class IEnumerable_string
{
	...
	{
		return IEnumerableMethods<string, nint>.InitCcw((delegate* unmanaged[Stdcall]<nint, nint*, int>)(&Do_Abi_First_0));
	}
	...
	private unsafe static int Do_Abi_First_0(nint thisPtr, nint* __return_value__)
	{
		*__return_value__ = 0;
		try
		{
			*__return_value__ = MarshalInterface<IEnumerator<string>>.FromManaged(IEnumerableMethods<string>.Abi_First_0(thisPtr));
		}
		catch (Exception ex)
		{
