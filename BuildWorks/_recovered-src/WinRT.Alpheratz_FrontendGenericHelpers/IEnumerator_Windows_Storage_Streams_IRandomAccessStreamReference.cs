...
internal static class IEnumerator_Windows_Storage_Streams_IRandomAccessStreamReference
{
	...
	private unsafe static int Do_Abi_MoveNext_2(nint thisPtr, byte* __return_value__)
	{
		...
		*__return_value__ = 0;
		try
		{
			flag = IEnumeratorMethods<IRandomAccessStreamReference>.Abi_MoveNext_2(thisPtr);
	...
	private unsafe static int Do_Abi_GetMany_3(nint thisPtr, int __itemsSize, nint items, uint* __return_value__)
	{
		...
		*__return_value__ = 0u;
		...
		try
		{
			num = IEnumeratorMethods<IRandomAccessStreamReference>.Abi_GetMany_3(thisPtr, ref items2);
	...
	private unsafe static int Do_Abi_get_Current_0(nint thisPtr, nint* __return_value__)
	{
		...
		*__return_value__ = 0;
		try
		{
			randomAccessStreamReference = IEnumeratorMethods<IRandomAccessStreamReference>.Abi_get_Current_0(thisPtr);
	...
	private unsafe static int Do_Abi_get_HasCurrent_1(nint thisPtr, byte* __return_value__)
	{
		...
		*__return_value__ = 0;
		try
		{
			flag = IEnumeratorMethods<IRandomAccessStreamReference>.Abi_get_HasCurrent_1(thisPtr);
			*__return_value__ = (flag ? ((byte)1) : ((byte)0));
		}
		catch (Exception ex)
		{
