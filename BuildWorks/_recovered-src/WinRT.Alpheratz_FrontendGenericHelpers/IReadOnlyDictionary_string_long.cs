...
internal static class IReadOnlyDictionary_string_long
{
	...
	private unsafe static int Do_Abi_Lookup_0(nint thisPtr, nint key, long* __return_value__)
	{
		...
		*__return_value__ = 0L;
		try
		{
			num = IReadOnlyDictionaryMethods<string, long>.Abi_Lookup_0(thisPtr, MarshalString.FromAbi(key));
	...
	private unsafe static int Do_Abi_HasKey_2(nint thisPtr, nint key, byte* __return_value__)
	{
		...
		*__return_value__ = 0;
		try
		{
			flag = IReadOnlyDictionaryMethods<string, long>.Abi_HasKey_2(thisPtr, MarshalString.FromAbi(key));
	...
	private unsafe static int Do_Abi_Split_3(nint thisPtr, nint* first, nint* second)
	{
		...
		*second = 0;
		...
		try
		{
			IReadOnlyDictionaryMethods<string, long>.Abi_Split_3(thisPtr, out first2, out second2);
			*first = first2;
			*second = second2;
		}
		catch (Exception ex)
	...
	private unsafe static int Do_Abi_get_Size_1(nint thisPtr, uint* __return_value__)
	{
		...
		*__return_value__ = 0u;
		try
		{
			num = IReadOnlyDictionaryMethods<string, long>.Abi_get_Size_1(thisPtr);
			*__return_value__ = num;
		}
		catch (Exception ex)
		{
